"""
Thread-Safe DeepSeek SQL Analyzer
Fixes SQLite threading issues
"""
...
class ThreadSafeDeepSeekAnalyzer:
    ...
    def _get_connection(self):
        ...
        if not hasattr(self._local, 'conn'):
            ...
            self._local.conn = sqlite3.connect(self.database_path, check_same_thread=False)
        return self._local.conn
    
    def _get_schema(self) -> str:
        """Get database schema (read-only, safe)"""
...
ORDER BY total_sales DESC;"""
    ...
    def _extract_sql(self, text: str) -> str:
        ...
        # Try to find any line with SELECT
        lines = text.split('\n')
        for line in lines:
...
SQL:"""
    ...
    def execute_sql(self, sql: str) -> pd.DataFrame:
        """Execute SQL safely with thread-local connection"""
